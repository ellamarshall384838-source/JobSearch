...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "linkedin_tab_password":    {"zh": "🔑 账号密码登录",           "en": "🔑 Email & Password"},
    "linkedin_tab_cookie":      {"zh": "🍪 Cookie 导入（推荐）",    "en": "🍪 Import Cookies (recommended)"},
    "linkedin_cloud_hint":      {"zh": "☁️ 云端模式：账号密码登录使用无头浏览器。若 LinkedIn 触发安全验证，请改用「Cookie 导入」方式（更稳定）。",
                                 "en": "☁️ Cloud mode: login uses a headless browser. If LinkedIn triggers a security check, use 'Import Cookies' instead (more reliable)."},
    "linkedin_local_hint":      {"zh": "本地模式：将弹出可见浏览器窗口，如遇 2FA 可手动完成。",
                                 "en": "Local mode: a visible browser window will open so you can complete 2FA if needed."},
    "linkedin_password_ph":     {"zh": "LinkedIn 密码",             "en": "LinkedIn password"},
    "linkedin_headless_login":  {"zh": "正在使用无头浏览器登录（约 30-60 秒）…",
                                 "en": "Logging in with headless browser (30-60 s)…"},
    "linkedin_cookie_title":    {"zh": "**推荐方式 · 3 步完成，无需密码**",
                                 "en": "**Recommended · 3 steps, no password needed**"},
    "linkedin_cookie_steps":    {"zh": "1. 在浏览器安装扩展 **[Cookie-Editor](https://cookie-editor.com/)**（Chrome / Firefox 均支持）\n2. 打开 [linkedin.com](https://www.linkedin.com)，确认已登录\n3. 点击扩展图标 → 右上角「导出」（Export） → 复制全部 JSON\n4. 粘贴到下方文本框，点击「导入」",
                                 "en": "1. Install **[Cookie-Editor](https://cookie-editor.com/)** in Chrome or Firefox\n2. Open [linkedin.com](https://www.linkedin.com) and confirm you are logged in\n3. Click the extension icon → top-right **Export** button → copy the JSON\n4. Paste into the text box below and click **Import**"},
    "linkedin_cookie_label":    {"zh": "粘贴 Cookie JSON",          "en": "Paste Cookie JSON"},
    "linkedin_cookie_import":   {"zh": "📥 导入 Cookie",            "en": "📥 Import Cookies"},
    "linkedin_cookie_empty":    {"zh": "请先粘贴从浏览器导出的 Cookie JSON。",
                                 "en": "Please paste the Cookie JSON exported from your browser first."},
